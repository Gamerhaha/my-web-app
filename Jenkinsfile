pipeline {
    ...
    environment {
        // AWS Configuration
        AWS_ACCOUNT_ID = '354935533710'  // Replace with your AWS Account ID
        ...
        EC2_HOST = 'ec2-13-49-246-149.eu-north-1.compute.amazonaws.com'  // Replace with your EC2 public DNS
        EC2_USER = 'ec2-user'
